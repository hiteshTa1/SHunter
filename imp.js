...
const api_popular_movies = `https://api.themoviedb.org/3/discover/movie?${API_KEY}&with_genres=28&with_companies=420`;
const api_top_rated_movies = `https://api.themoviedb.org/3/discover/movie?${API_KEY}&with_genres=28&with_companies=429`;
const api_popular_tv_shows = `https://api.themoviedb.org/3/discover/tv?${API_KEY}&with_genres=10759&with_companies=420`;
const api_top_rated_tv_shows = `https://api.themoviedb.org/3/discover/tv?${API_KEY}&with_genres=10759&with_companies=429`;
